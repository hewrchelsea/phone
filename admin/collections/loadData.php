...
if (empty($id)) {
    echo "<p class='msg'>Error loading the chosen collection. Please try a different collection</p>";
}
...
<form action="./updateLeague.php" method="POST" class="updateLeague_section" id="updateLeague" data-id="<?php echo $row['id']; ?>" autocomplete="off">
    ...
    <div class="upload">
        <label for="input_file_2">Collection Logo</label>
    ...
    <div class="preview" style="display: flex">
        ...
        <img src="../../assets/collections/<?php echo $row['img'] . "?". mt_rand(10000, 99999); ?>" alt="Print file">
        <h3 class="image_title"></h3>
    </div>
    <ul class="update_errorAll"></ul>
    <ul class="update_successAll"></ul>
    <button type="submit">Update Collection</button>
    <button type="button" class="delete" id="delete" data-id="<?php echo $row['id']; ?>">Delete Collection</button>
